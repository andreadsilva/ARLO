...
if __name__ == '__main__':
    ...
    f = open('/home/andrea/ARLO/demo_LQR.txt', 'r')
    ...
    demo_batch_size = Categorical(hp_name='demo_batch_size', obj_name='demo_batch_size_sac', 
                            current_actual_value=16, possible_values=[4, 8, 16, 32], to_mutate=True)
    ...
    n_epochs_pretraining = Integer(hp_name='n_epochs_pretraining', current_actual_value=5000, range_of_values=[2000,40000], to_mutate=True, 
                    obj_name='n_epochs')
    ...
    n_episodes_per_fit = Integer(hp_name='n_episodes_per_fit', current_actual_value=20, range_of_values=[1, 500], to_mutate=True, 
                                 obj_name='n_episodes_per_fit')
    
    lambda1 = Real(hp_name='lambda1', obj_name='lambda1', 
                    current_actual_value=1, range_of_values=[.2, 2], to_mutate=True) 
